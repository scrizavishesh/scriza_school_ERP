...
import { TeacherOnlinePostApi } from '../Utils/Apis'
...
import { TeacherOnlineCourseGetAllApi } from '../Utils/Apis'
import { TeacherOnlineDeleteApi } from '../Utils/Apis'
import { TeacherSubjectByClassIdInSyllabusGetAllApi } from '../Utils/Apis'
import { TeacherOnlineGetById } from '../Utils/Apis'
import { TeacherOnlinePutApi } from '../Utils/Apis'
...
const OnlineCourse = () => {
  ...
  const MyTeacherGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await TeacherGetAllApi(68);
              ...
              <tbody className='heading-14 align-middle greyTextColor'>
                {
                  onlineAllData.map((item, index) => (
                    <tr className='heading-14' >
                      ...
                      <td className='  greyText'>{item.classId}</td>
                      <td className=' greyText'>
            ...
            <>
              <div className="offcanvas-end offcanvas" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel" ref={offcanvasRef}>
                ...
                <div class="offcanvas-body pt-0">
                  <div className="input " >
                    <div className="mb-1  ">
                      <label for="exampleFormControlInput1" className="form-label label-color heading-16">Class1</label>
