...
const Expense = () => {
  ...
  const MyIncomeGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await IncomeCategorygetAllApi(expense, searchKey, pageNo, pageSize);
      console.log('my expense category in come page data', response);
  ...
  const MyExpense2GetAllApi = async () => {
    setLoader(true)
    try {
      const response = await ExpenseAllApi(expense, searchKey, pageNo, pageSize, startDate, endDate, categoryId);
      console.log('my Expense all  data SAQIB ', response);
      if (response?.status === 200) {
        // toast.success(response?.data?.message)
              ...
              <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" ref={offcanvasRef}>
                ...
                <div className="offcanvas-body pt-0">
                  <div class="mb-3">
                    ...
                    <input type="date" class="form-control form-control-sm" onChange={(e) => handleDate(e.target.value)} id="exampleFormControlInput1" placeholder="Select Title" />
                  </div>
                  <div className='pt-1'>
                    {isValidDateRequired && (
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" onChange={(e) => handleAmount(e.target.value)} id="exampleFormControlInput1" placeholder="Enter Amount" />
                  </div>
                  <div className='pt-1'>
