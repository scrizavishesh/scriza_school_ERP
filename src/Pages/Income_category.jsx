...
const Income_category = () => {
  ...
  const MyIncomeGetAllApi = async () => {
    ...
    try {
      ...
      console.log("my income category data00000000", response);
      if (response?.status === 200) {
        // toast.success(response?.data?.message)
            ...
            >
              ...
              <div className="offcanvas-body pt-0">
                {/* <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1"  onChange={(e) =>  handleName(e.target.value)} placeholder="Income Category Name" />
                  </div> */}
